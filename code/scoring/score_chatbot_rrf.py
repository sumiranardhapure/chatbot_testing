...
Usage:
    Run from any directory:
        python3 code/scoring/score_chatbot_rrf.py
    Input files are read from data/, output is written to output/scoring/.

Output:
    output/scoring/Chatbot_Scoring_Results_rrf.xlsx — two sheets: Summary, Standard Scores.
"""
...
OUTPUT_FILE         = OUTPUT_DIR / "scoring" / "Chatbot_Scoring_Results_rrf.xlsx"
